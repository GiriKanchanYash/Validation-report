...
# ▶▶▶  CHANGE ONLY THIS  ◀◀◀
# =============================================================================
DB_NAME = "OrderLens"     # e.g. "DEALER" | "ORDERLENS" | "PROCURE2PAY"
# =============================================================================
...
FABRIC_CONFIG = {
    ...
    "database":        os.getenv("FABRIC_DATABASE",           "OrderLens"),
    "mart_database":   os.getenv("FABRIC_WAREHOUSE_DATABASE", "DW_OrderLens"),
